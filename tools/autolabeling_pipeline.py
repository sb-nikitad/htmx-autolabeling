...
from firebase_download import download_latest_videos, clean_firebase_response, extract_data_to_csv
from autolabeling import videos_processing
from tqdm import tqdm
from logs import log_run, update_log
from api_3dgolf import download_video_files, tag_videos
...
def run_pipeline(conf_thresh = 0.8, confidence_club = 0.7, date_start='', date_end='', size = 1, model_name = '', imported=False, tag_mode=False, keyword='', api=False, progress=gr.Progress()):
    ...
    model = "./models/lpn_pose2d_tflite_38_177k.tflite"
    ...
    download_video_files(videos_csv, dataDir, imported)
