...
os.environ["API_KEY"] = "BUe5kASp/txcYgV8nrFum!rXE55HLC!GQm=?NsuMgnZvDJ8p/XmaOP08BlbsLcwKRJ2UDDOSQPirxzJFfGq!reNg0KYTN8F2Msm8JO3MNf8RePL3391zplTbJDsPuGZ?"
...
def download_latest_videos(size = 2, start_timestamp = None, end_timestamp = None):
    ...
    url = "https://us-central1-sportsbox-product-baseball.cloudfunctions.net/api/elastic/search/video"
