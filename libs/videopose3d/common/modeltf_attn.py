...
class TemporalModelTF(TemporalModelBaseTF):
    ...
    def __init__(self, num_joints_in, in_features, num_joints_out,
                 filter_widths, causal=False, dropout=0.25, channels=1024, dense=False, model_type='all_sigmoid'):
        """
    ...
    def _forward_blocks(self, x):
        ...
        for i in range(len(self.pad) - 1):
            ...
            x = res + self.drop(self.relu(self.layers_bn[num_layers * (i + 1) - 1](self.layers_conv[num_layers * (i + 1) - 1](x))))
